...
class DataConfig:
    ...
    # Optional retarget-conditioned override. When unset, retarget uses the
    # same meta/reference ratio as other non-obs condition modes.
    meta_beta_retarget_meta_area_condition_prob: float | None = None
    meta_beta_retarget_reference_action_condition_prob: float | None = None
    ...
    meta_beta_imagine_cache_condition_prob: float = 0.50
...
class LeRobotXTrainerMetaDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        return dataclasses.replace(
            ...
            meta_beta_retarget_meta_area_condition_prob=self.meta_beta_retarget_meta_area_condition_prob,
            meta_beta_retarget_reference_action_condition_prob=self.meta_beta_retarget_reference_action_condition_prob,
            ...
            meta_beta_imagine_cache_condition_prob=self.meta_beta_imagine_cache_condition_prob,
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(
            ...
            action_loss_weight=1.0,
            meta_loss_weight=1,
            meta_contrastive_loss_weight=0.4,
            meta_stop_backbone_grad=False,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotXTrainerStructuredMetaDataConfig(
            ...
            meta_beta_imagine_cache_condition_prob=0.90,
    ...
    TrainConfig(
        ...
        data=LeRobotXTrainerStructuredMetaDataConfig(
            ...
            use_delta_joint_actions=True,
            action_stride=3,
            meta_retarget_cache_dir="./assets/pi05_xtrainer_meta_aux_structured_12d_delta_beta_black_ring_hookNewUpper30_60_stick10_9type_12D_classified_stride3/retarget_cache",
    ...
    TrainConfig(
        name="pi05_xtrainer_meta_aux_structured_12d_delta_beta3_reference",
        model=pi0_config.Pi0Config(
            max_token_len=320,
            pi05=True,
            meta_model=True,
            ...
            action_loss_weight=1.0,
            meta_loss_weight=1,
            meta_contrastive_loss_weight=0.0,
            meta_stop_backbone_grad=False,
            freeze_vlm_backbone=False,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotXTrainerStructuredMetaDataConfig(
            ...
            meta_beta_reference_action_condition_prob=0.80,
            meta_beta_retarget_meta_area_condition_prob=0.0,
            meta_beta_retarget_reference_action_condition_prob=1.0,
            meta_beta_self_same_chunk_reference_action_condition_prob=0.80,
            meta_beta_obs_only_condition_prob=0.0,
            meta_beta_non_retarget_obs_only_condition_prob=0.20,
            meta_beta_imagine_cache_condition_prob=0.90,
            meta_beta_pair_retarget_same_tool_only=True,
            meta_beta_online_async_enabled=True,
            meta_beta_online_num_workers=1,
        ...
        weight_loader=weight_loaders.ReferenceStudentCheckpointWeightLoader(
            "/mnt/sdc/cy/ckpt/tool_adaptation/black_ring_hookNewUpper30_60_stick10_9type_12D_retarget02_stride3/params"
        ),
        freeze_filter=pi0_config.Pi0Config(meta_model=True, meta_reference_student_model=True).get_freeze_filter(),
        num_train_steps=50_000,
        batch_size=32,
    ),
    TrainConfig(
        name="pi05_xtrainer_meta_aux_structured_12d_delta_beta3_reference_black_ring_hookNewUpper30_60_stick10_9type_12D_classified_stride3",
        model=pi0_config.Pi0Config(
            max_token_len=320,
            pi05=True,
            meta_model=True,
    ...
    TrainConfig(
        name="pi05_xtrainer_meta_aux_structured_12d_delta_beta3_reference_black_ring_hookNewUpper45_60_stick10_18type_12D_classified_stride3",
        model=pi0_config.Pi0Config(
            max_token_len=320,
            pi05=True,
            meta_model=True,
        ...
        data=LeRobotXTrainerStructuredMetaDataConfig(
            repo_id="/inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/cy/datasets/tool_adaptation/black_ring_hookNewUpper45_60_stick10_18type_12D_classified",
            base_config=DataConfig(prompt_from_task=True),
            output_action_dim=32,
            max_meta_areas=3,
            meta_area_pose_dim=12,
            use_delta_joint_actions=True,
            action_stride=3,
            meta_retarget_cache_dir="./assets/pi05_xtrainer_meta_aux_structured_12d_delta_beta3_reference_black_ring_hookNewUpper45_60_stick10_18type_12D_classified_stride3/retarget_cache",
            meta_retarget_cache_prob=1.0,
            meta_beta_enabled=True,
            meta_beta_self_same_chunk_prob=0.12,
            meta_beta_same_episode_diff_chunk_prob=0.08,
            ...
            meta_beta_non_retarget_obs_only_condition_prob=0.20,
            meta_beta_imagine_cache_condition_prob=0.90,
            meta_beta_pair_cache_dir="./assets/pi05_xtrainer_meta_aux_structured_12d_delta_beta3_reference_black_ring_hookNewUpper45_60_stick10_18type_12D_classified_stride3/beta_pair_retarget_cache",
            meta_beta_pair_retarget_same_tool_only=True,
            meta_beta_online_async_enabled=True,
            meta_beta_online_worker_group="dataloader",
            meta_beta_online_num_workers=1,
        ...
        weight_loader=weight_loaders.ReferenceStudentCheckpointWeightLoader(
            "/inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/cy/openpitmp/openpi-meta-action/checkpoints/pi05_xtrainer_meta_aux_structured_12d_delta_black_ring_hookNewUpper45_60_stick10_18type_12D_classified_retarget02_stride3/black_ring_upper45_18type_structured_direct_retarget02_b32_20260523T041144Z/9000/params"
        ),
        freeze_filter=pi0_config.Pi0Config(meta_model=True, meta_reference_student_model=True).get_freeze_filter(),
        num_train_steps=35_000,
        batch_size=32,
